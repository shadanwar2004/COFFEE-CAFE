          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Crafted from carefully selected beans, our premium blended coffee delivers
  a rich aroma and smooth taste in every sip. Perfectly roasted to give you
  a balanced flavor that energizes your day and comforts your moments.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500">
                      Just as elegant code is built with care, every cup of tea and coffee is brewed with precision, patience, and passion for a refined taste.
                    </p>
                  </div>
                </div>
              </div>
